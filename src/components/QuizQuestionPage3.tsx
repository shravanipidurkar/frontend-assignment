...
const QuizQuestionPage3: React.FC = () => {
  const navigate = useNavigate();
  const [selectedOption, setSelectedOption] = useState<number | null>(null);

  const options = ["Two", "Infinite", "One Hundred"];
      ...
      <div className="relative w-[85%] max-w-[1200px] min-h-[80%] flex flex-col items-center mt-10 pb-20">
        ...
        <div className="absolute bottom-10 right-10 flex gap-3">
          <button
            ...
            className="w-[178px] h-[48px] bg-[linear-gradient(89.72deg,#C6E9F7_0.09%,#E5F8FF_99.91%)]
            flex items-center justify-center font-medium
            rounded-[10px] shadow hover:scale-105 transition"
          >
            Submit
          </button>
